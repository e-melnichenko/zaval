...
<div class="contact_line_block">
  <div class="container">
    <div class="contanct_line_form">
      <h3>Есть вопросы?<br> Есть ответы!</h3>
      <div class="text">Ответим на любой вопрос о работе с нашим сервисом и подскажем на чем следует остановить свой выбор. Обращайтесь!</div>
      <?php echo do_shortcode( '[contact-form-7 id="253"]' ); ?>
    </div>
  </div>
</div>
    ...
    <div class="footer_inner">
      ...
      <div class="footer_content">
        ...
        <div class="contact_head_a">
          ...
          <div class="time"><i class="fa fa-clock-o"></i> Пн-Сб 08.00 - 18.00 Вс 8.00-13.00</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="overlay">
  <div class="overlay__modal overlay_iframe">
    <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A019a5d63f42e4b06f60a7d248cf825edc27c4c531bbe15b800eaa9ab722f884a&amp;source=constructor" width="100" height="100" frameborder="0"></iframe>
